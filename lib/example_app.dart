...
class ExampleApp extends StatefulWidget {
  const ExampleApp({Key? key, required this.title}) : super(key: key);
...
class _ExampleAppState extends State<ExampleApp> {
  final List<Actor> actors = [
    ...
    Actor(age: 50, name: 'Leonardo', lastName: 'DiCaprio'),
    Actor(age: 51, name: 'Johnny', lastName: 'Depp'),
    Actor(age: 52, name: 'Robert', lastName: 'De Niro'),
    Actor(age: 53, name: 'Tom', lastName: 'Hardy'),
    Actor(age: 54, name: 'Denzel', lastName: 'Washington'),
    Actor(age: 55, name: 'Ben', lastName: 'Affleck'),
  ];
